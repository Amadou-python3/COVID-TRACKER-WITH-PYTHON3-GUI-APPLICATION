...
class Application(tk.Frame):
	...
	def create_frames(self):
		self.updates = tk.LabelFrame(self, text='Updates',
					...
					bg="slate gray",fg="red",bd=5,relief=tk.GROOVE)
		...
		self.graph = tk.LabelFrame(self, text='',
					font=("times new roman",15,"bold"),
					bg="white",fg="red",bd=5,relief=tk.GROOVE)
	...
	def chart_type_widgets(self):
		self.bar = tk.Button(self.chart_type, bg='blue', fg='red', font=10)
		self.bar['text'] = 'Bar'
		self.bar['command'] = self.bar_chart
		self.bar.config(width=5, height=1)
		self.bar.grid(row=0, column=0, pady=4, padx=15)

		self.pie = tk.Button(self.chart_type, bg='green', fg='red', font=10)
		self.pie['text'] = 'Pie'
	...
	def searchbar_widgets(self):
		...
		self.search = tk.Button(self.searchbar, bg='blue', fg='red', font=10)
	...
	def controls_widgets(self):
		...
		self.refresh = tk.Button(self.controls, bg='blue', fg='red', font=10)
		...
		self.world = tk.Button(self.controls, bg='blue', fg='red', font=10)
		...
		self.top10 = tk.Button(self.controls, bg='blue', fg='red', font=10)
	...
	def searchData(self):
		...
		if self.value == '':
			...
			if self.value.upper() in ['USA', 'UK', 'UAE', 'CAR', 'CI']:
